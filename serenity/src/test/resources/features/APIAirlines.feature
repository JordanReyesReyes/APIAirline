...
Feature: API Aerolíneas
  ...
  @CP03
  Scenario: Actualizar una aerolínea exitosamente
    Given el actor establece el endpoint para actualizar una aerolinea
    When el envia una solicitud HTTP PUT con el "1" y los datos actualizados
    Then el codigo de respuesta deberia ser 404

  @CP04
  Scenario: Eliminar una aerolínea exitosamente
